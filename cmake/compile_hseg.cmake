...
if(USE_CUDA)
    set(HSEG_INCLUDE_SYS_DIRS ${HSEG_INCLUDE_SYS_DIRS} ${CUDA_INCLUDE_DIRS})
    include_directories(${HSEG_INCLUDE_SYS_DIRS})
    set(HSEG_LIBS ${HSEG_LIBS} ${CUDA_LIBRARIES})
    CUDA_ADD_LIBRARY(hseg ${SOURCE_FILES_FULL_PATH})
    CUDA_ADD_CUBLAS_TO_TARGET(hseg)
else()
