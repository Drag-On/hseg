...
set(HSEG_INCLUDE_DIRS ${ROOT_DIR}/include)
set(HSEG_INCLUDE_SYS_DIRS ${trw_s_INCLUDE_DIRS} ${properties_INCLUDE_DIRS} ${Boost_INCLUDE_DIRS} ${OpenCV_INCLUDE_DIRS} ${EIGEN3_INCLUDE_DIR} ${PNG_INCLUDE_DIRS} ${MATIO_INCLUDE_DIRS})
set(HSEG_LIBS trw_s properties ${OpenCV_LIBS} ${Boost_LIBRARIES} ${PNG_LIBRARIES} ${MATIO_LIBRARIES})
PREPEND(SOURCE_FILES_FULL_PATH ${ROOT_DIR} ${HSEG_SOURCE_FILES})
